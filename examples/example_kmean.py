...
if __name__ == "__main__":
    ...
    fig_outputdir = '/mnt/c/Users/OuKu/Developments/phenology/data/test_kmean_results'
    ...
    cl_mean_centroids_nonnan = np.delete(km.cl_mean_centroids, np.where(idx_nan_row)[0], axis=0)
    cl_mean_centroids_nonnan = np.delete(cl_mean_centroids_nonnan, np.where(idx_nan_col)[0], axis=1)
    ...
    # plt.savefig(fig_outputdir + 'Spatial_info.png', format='png', transparent=True, bbox_inches="tight")
    # plt.close(fig)
    ...
    plt.savefig(fig_outputdir + 'Temporal_info.png', format='png', transparent=True, bbox_inches="tight")
